...
enum MESSAGE_TYPE
{
    ...
    MESSAGE_TYPE_HANDSHAKE_INITIATION = 0x40414243,
    MESSAGE_TYPE_HANDSHAKE_RESPONSE = 0x44454647,
    MESSAGE_TYPE_HANDSHAKE_COOKIE = 0x48494a4b,
    MESSAGE_TYPE_DATA = 0x4c4d4e4f
};
